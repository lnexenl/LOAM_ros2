 ...
 * Attitude Estimation](http://mars.cs.umn.edu/tr/reports/Trawny05b.pdf). This
 * matrix is derived in Section 1.5 of the report by finding the Quaterion Time
 * Derivative.
 *
 * \f{align*}{
 ...
 * Timothy D. Barfoot @cite Barfoot2017. Specifically it is the following (with
 ...
 * Timothy D. Barfoot
 * @cite Barfoot2017. See @ref Jl_so3() for the definition of the left Jacobian
 * of SO(3).
 *
 * @param w axis-angle
